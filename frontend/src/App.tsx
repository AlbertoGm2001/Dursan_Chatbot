      ...
      <div className="header">
        <div className="header-inner">
          <div className="header-logo">
            <img src="https://dursan-chatbot.s3.eu-west-1.amazonaws.com/dursan_logo.jpeg" alt="Dursan Logo" />
          </div>
          <div>
                ...
                <div key={rec.id} className="car-card">
                  {rec.image_url && (
                    <div className="car-image">
                      <img
                        src={`https://dursan-chatbot.s3.eu-west-1.amazonaws.com/scrap-images/${rec.image_url}`}
                        alt={`${rec.car_brand} ${rec.car_model}`}
                      />
                    </div>
                  )}
